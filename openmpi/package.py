...
class Openmpi(AutotoolsPackage):
	...
	##My addition
	config_args.append('--with-pmix')
	config_args.append('--with-verbs')
	config_args.append('--enable-mpirun-prefix-by-default')
	config_args.append('--disable-dlopen')
	config_args.append('--with-slurm')
		...
		config_args.append('--with-pmi-libdir={0}'.format(
		    '/opt/slurm/current/lib/'))
            else:
